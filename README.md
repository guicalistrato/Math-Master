...
# Conclusion
MathMaster was quite challenging to create but was very rewarding, and became my favorite problem set from CS50, probably because of the emotional value. I think I designed it in a way that would make it very easy to do updates and expand its features in the future, and it could prove to be a useful website for students if released someday.
